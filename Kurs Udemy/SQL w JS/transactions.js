...
// Transakcje pozwalaja na zabezpieczenie się przed wprowadzeniem niekompletnych
// danych do bazy. Jeśli po drodze pojawi się błąd przy pracy z bazą to może wywołać
...
async function insert(employee) {
    ...
    const [result] = await connection.query(
        query,
        [employee.name, employee.surname, employee.email, employee.occupation, employee.age]
        );
...
try {
    ...
    console.log("Saved employee1 with id: ", employee2.id);
